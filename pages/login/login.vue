...
<script>
import { ACCESS_TOKEN, USER_NAME, USER_INFO } from "@/store/mutation-types.js";
...
export default {
  ...
  onLoad: function () {
    ...
    // #endif
    uni.$on('loginLoading',this.closeLoginLoading)
  },
  onUnload(){
    uni.$off(['loginLoading',this.closeLoginLoading])
  },
  methods: {
